      ...
      <div className="nature-card w-full max-w-md max-h-[92dvh] overflow-y-auto animate-slide-up rounded-t-3xl sm:rounded-[20px_4px_20px_4px] relative">
        ...
        <div className="p-6 space-y-5">
          ...
          <button
            ...
            disabled={loading}
            className="w-full py-4 bg-white text-forest-deep rounded-leaf font-display font-bold uppercase tracking-widest flex items-center justify-center gap-3 hover:bg-wheat shadow-nature transition-all active:scale-95 disabled:opacity-50"
          >
          ...
          {/* Secondary Action: Guest Bypass */}
          <button
            onClick={loginAsGuest}
            className="w-full py-3 bg-forest/30 border border-forest-light/20 rounded-leaf-sm text-wheat text-[11px] font-black uppercase tracking-widest hover:bg-forest/40 transition-all flex items-center justify-center gap-2 group"
          >
          ...
          <div className="relative flex items-center gap-4 py-2">
            ...
            <span className="text-[9px] text-white/20 font-bold uppercase tracking-widest">Other Options</span>
            <div className="flex-1 h-px bg-white/5" />
          </div>

          <form onSubmit={handleSubmit} className="space-y-4 opacity-70 hover:opacity-100 transition-opacity">

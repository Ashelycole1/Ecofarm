          ...
          <div className="space-y-4">
            {previewUrl ? (
              ...
              <button 
                ...
                className="aspect-square sm:aspect-video sm:h-48 w-full rounded-2xl border-2 border-dashed border-border-strong bg-bone-low flex flex-col items-center justify-center gap-4 cursor-pointer hover:bg-white transition-all shadow-inner group"
              >
                <div className="w-16 h-16 rounded-2xl bg-white flex items-center justify-center text-ochre border border-border-soft shadow-sm group-hover:scale-110 transition-transform">
                  <Camera size={28} />
                </div>
                <div className="text-center">
                  <p className="font-body text-[12px] text-ink-muted font-bold uppercase tracking-[0.15em]">Scan Plant Photo</p>
                  <p className="font-body text-[10px] text-ink-faint mt-1">Take a photo or upload from gallery</p>
                </div>
              </button>
            )}
